...
class TestMaxInteger(unittest.TestCase):
    ...
    def testmodule_docstring(self):
        """Tests for module docsting"""
        m = __import__('6-max_integer').__doc__
        self.assertTrue(len(m) > 1)

    def testfunction_docstring(self):
